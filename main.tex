...
%\usepackage[svgnames, dvipsnames, cmyk]{xcolor}
...
\hypersetup{
    colorlinks,
    allcolors = blue!90!Green,
    pdfauthor = Benjamin Loi,
    pdftitle = Intro. to Linear Algebra for Earth Sci. Students,
    pdfsubject = First Edition,
    pdfkeywords = {Mathematics, Earth Science, Linear Algebra}
}
...
\include{chapter15_Factorization}
\include{chapter16_DynSys}
\include{chapter17_Tensor}
\include{answers}
\include{chapterAppend}
\include{reference}
