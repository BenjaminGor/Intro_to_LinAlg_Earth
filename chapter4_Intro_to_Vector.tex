...
\begin{subfigure}{.49\textwidth}
  ...
  % https://tex.stackexchange.com/questions/287284/drawing-a-diagram-of-a-three-cycle
    ...
    \end{tikzpicture}
    \caption{A helper cyclic diagram for memorizing Definition \ref{defn:crossijk}. A clockwise/anti-clockwise permutation produces a positive/negative standard unit vector of the third.}
\end{subfigure}%
\begin{subfigure}{.49\textwidth}
  \centering
